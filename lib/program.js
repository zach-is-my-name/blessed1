  ...
  this.output.on(
    ...
    (this.output._resizeHandler = function () {
      Program.instances.forEach(function (program) {
        ...
        var time =
          typeof program.options.resizeTimeout === "number" ? program.options.resizeTimeout : 300;
...
Program.prototype._write = function (text) {
  ...
  if (this.useBuffer) {if(text.includes('index.mjs')){debugger}
