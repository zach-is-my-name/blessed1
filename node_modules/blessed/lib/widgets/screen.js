...
// WATCH LX
  ...
  for (y = start; y <= end; y++) {
    ...
    for (x = 0; x < line.length; x++) {
      ...
      // TODO check if it does the tput stuff on the first code or just the closing code
      // Optimize by comparing the real output
      // buffer to the pending output buffer.
      // TODO check and find origin of lx value
      if (data === o[x][0] && ch === o[x][1]) {
        ...
        if (this.tput.strings.parm_right_cursor) {
         ...
         // TODO Actually, could be the cursor move code.'\x1B[28C\x1B[1;' Investigate.  Use erase_chars to avoid erasing the whole line.
      ...
      if (data !== attr) {
        ...
        if (data !== this.dattr) {
          // TODO also test for OSC here and if true, assign
          out += "\x1b[";

          bg = data & 0x1ff;
          fg = (data >> 9) & 0x1ff;
          flags = data >> 18;
          // TODO but still need to add the flag here in this case,  out += 8;;
         // also the 0x07 where appropriate
          // bold
          if (flags & 1) {
            out += "1;";
          }
          ...
          //TODO  this will get tricky with the double semi-colon because it eliminating one already existing at the end of the current "out"
          if (out[out.length - 1] === ";") out = out.slice(0, -1);
         // TODO here it adding where OSC link doesn't have.  could do a test for a third semi-colon and replace... implying you tested above and inserted 2 to make a total of 3
          out += "m";
        }
      }
...
// run through bold phrase to see how the closing attribute is added.
// special attention to "(def >> 18) & 0x1ff;" 
// why def is important; why shift it; why bit AND
